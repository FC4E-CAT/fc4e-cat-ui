...
function ActorCard({title, link, link_text, image, disabled}:{
    title: string;
    link: string;
    link_text: string;
    image: string;
        ...
        return (
            <>
                ...
                <div className="d-flex justify-content-center align-items-start">
                    <img className="card-img-top" style={{width: "150px", height: "150px"}} src={image} alt={link} />
                </div>
                <div className="card-body mb-1">
                    ...
                    <div className="mt-2">
                        <div className="d-flex justify-content-start align-items-center">
                            <Link to={link} className="text-decoration-none me-1">{link_text} <span role="button"><FaExternalLinkAlt /></span></Link>
                        </div>
                    </div>
                </div>
            </>
        ...
        return (
            <>
                ...
                <div className="card-body overflow-scroll">
                    ...
                    <Link to={link} className="my-2" >{link_text}</Link>
                </div>
            </>
        )
    }
