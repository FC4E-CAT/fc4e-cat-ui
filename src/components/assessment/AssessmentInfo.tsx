    ...
    return (
        <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
                <Accordion.Header><span><FaUserAlt color="green" className="me-2" />Submitter</span></Accordion.Header>
                <Accordion.Body>
                        <Row>
                            <Col>
            ...
            <Accordion.Item eventKey="1">
                <Accordion.Header><span><FaCog color="orange" className="me-2" />Subject of assessment <em>Object, Entity or Service</em>:</span></Accordion.Header>
                <Accordion.Body>
                    <Row className="m-2">
                        <Col>
                            <InputGroup className="mb-3">
            ...
            <Accordion.Item eventKey="2">
                <Accordion.Header><span><FaLock color="crimson" className="me-2" />Rights, Licencing, or Re-use</span></Accordion.Header>
                <Accordion.Body>
                    <Row className="m-2">
                        <Col>
