    ...
    <>
      {formMode === "new" || formMode === "edit" ? (
        <div className={styles["principle-form"]}>
          ...
          {isEditingDisabled && (
            <div className={styles["criterion-edit-warning"]}>
          ...
          <div className={styles["form-group"]}>
            ...
            <div className="position-relative" ref={imperativesDropdownRef}>
              <div
                className={`${styles["form-control"]} d-flex justify-content-between align-items-center`}
                onClick={() =>
                  !isEditingDisabled &&
        ...
        <div className={`${styles["principles-list-container"]}`}>
          <div className={styles["principles-list"]}>
            ...
            {filteredCriteria.length === 0 ? (
              ...
              <div className={`${styles["principles-grid"]} principles-grid`}>
                {filteredCriteria?.map((criterion) => (
                  <div
                    key={criterion.cri}
                    data-criterion-id={criterion.id}
                    className={`${styles["principle-card"]} ${selectedRegistryCriterionId === criterion.cri ? styles["selected"] : ""}`}
                    onClick={() =>
                ...
                {hoveredCriterion && hoveredCriterionData && (
                  <div
                    className={styles["motivations-tooltip"]}
                    style={{
