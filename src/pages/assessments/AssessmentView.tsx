    ...
    <Col className="col-sm-9">
            <Row>
              ...
              <Col className="text-center">
                <span className="font-weight-500 text-xs text-gray-500">Principles</span>
                <p><span className="fs-1 text-primary bold">9</span></p>
              </Col>
              <Col className="text-center">
                <span className="font-weight-500 text-xs text-gray-500">Criteria</span>
                <p><span className="fs-1 text-primary bold">9</span><span className="fs-6 text-secondary">/10</span></p>
              </Col>
              <Col className="text-center">
                <span className="font-weight-500 text-xs text-gray-500">Mandatory</span>
                <p><span className="fs-1 text-primary bold">8</span><span className="fs-6 text-secondary">/10</span></p>
              </Col>
              <Col className="col-md-auto col col-lg-1  text-center">
                <span className="font-weight-500 text-xs text-gray-500">Optional</span>
                <p><span className="fs-1 text-primary bold">8</span><span className="fs-6 text-secondary">/10</span></p>
              </Col>
            </Row>
