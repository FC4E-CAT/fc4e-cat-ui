  ...
  return (
    ...
    <Form onSubmit={onSubmit}>
      <Row className="mb-2">
        <Col>
          <Form.Group>
            ...
            <input {...register("name", {required: { value: true, message: "Name is required" }, minLength: { value: 3, message: "Minimum length is 3"} })} type="text" className={`form-control ${errors.name ? "is-invalid" : ""}`} id="inputName" />
        ...
        <Col>
          <Form.Group>
            ...
            <input  {...register("surname", {required: { value: true, message: "Surname is required" }, minLength: { value: 3, message: "Minimum length is 3"} })} type="text" className={`form-control ${errors.surname ? "is-invalid" : ""}`} id="inputSurname" />
      ...
      <Form.Group>
        ...
        <input  {...register("email", {required: { value: true, message: "Email is required" }, pattern: { value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i , message: "Invalid email address"} })} type="email" className={`form-control ${errors.email ? "is-invalid" : ""}`} id="inputEmail" aria-describedby="emailHelp" />
